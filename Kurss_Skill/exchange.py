...
def help(message: telebot.types.Message):
    text = "Чтобы начать работу введите команду боту в следующем " \
           ...
           "Увидит список доступных валют: /values"
...
def convert(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise APIException("Не правильно введены параметры!")
        ...
        text = f'Курс: {base}/{quote}:' \
               f'{round(total_base / float(amount), 2)}' \
               f' {keys[quote]}.\n' \
